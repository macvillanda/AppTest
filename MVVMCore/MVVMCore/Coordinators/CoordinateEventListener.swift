...
extension CoordinateEventListener: CoordinatorDelegate {
    public func present(screen: ScreenCoordinated) -> CoordinatedInitiable? {
        coordinateEvent.event = CoordinateEvent.Event.present(screen: screen)
        return nil
    }
    
    public func presentModal(screen: ScreenCoordinated, config: ModalConfig) -> CoordinatedInitiable? {
